    ...
    <form onSubmit={handleSubmit}>
      ...
      <label>
        ...
        <textarea
          ...
          onChange={(event) => setPrimaryMaterial(event.target.value)}
        />
      </label>
      ...
      <label>
        ...
        <textarea
          ...
          onChange={(event) => setSecondaryMaterial(event.target.value)}
        />
      </label>
      ...
      <label>
        ...
        <input
          type="text"
          value={focusOnStudent}
          onChange={(event) => setFocusOnStudent(event.target.value)}
        />
      </label>
      ...
      <label>
        ...
        <textarea
          ...
          onChange={(event) => setStudentPerformance(event.target.value)}
        />
      </label>
      ...
      <label>
        ...
        <textarea
          value={studentSurprise}
          onChange={(event) => setStudentSurprise(event.target.value)}
        />
      </label>
